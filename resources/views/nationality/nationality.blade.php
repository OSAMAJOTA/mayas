...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">مدخلات النظام</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/  الجنسيات   </span>
            </div>
        </div>
        ...
        @endif
            ...
            <div class="col-sm-6 col-md-3">
                ...
                <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo1"> <i
                        class="fas fa-plus"></i>&nbsp; اضافة  جنسية</a>
            </div>
          <br>   <br>   <br>
                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="example1" data-page-length="50">
                            ...
                            <tr>
                                ...
                                <th class="border-bottom-0">اسم الجنسية</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">اضافة جنسية</h6><button aria-label="Close" class="close" data-dismiss="modal"
                ...
                <div class="modal-body">
                    <form action="{{ route('nationality.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nationalities_name" name="nationalities_name">
                        </div>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">تعديل الجنسية</h5>
...
@section('js')
    ...
    <script>
        $('#exampleModal2').on('show.bs.modal', function(event) {
            ...
            var nationalities_name = button.data('nationalities_name')

            var modal = $(this)
            modal.find('.modal-body #id').val(id);
            modal.find('.modal-body #nationalities_name').val(nationalities_name);
